...
def add_parser(subparsers):
    ...
    parser.add_argument(
        ...
        game.""")
    parser.add_argument(
        '--count', metavar='<count>', type=utils.pos_int,
        default=argparse.SUPPRESS, help="""The number of samples to compute for
...
async def run(args):
    ...
    for key in ['output', 'types', 'method', 'recipient', 'tag',
                'email_verbosity', 'verbose']:
        params.pop(key)
