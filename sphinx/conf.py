...
apidoc.main(['<prog-name>', '-efo', '.', path.join('..', 'egta')])
...
project = 'Empirical Game-Theoretic Analysis'
...
latex_documents = [
    (master_doc, 'egta.tex', 'Empirical Game-Theoretic Analysis Documentation',
...
man_pages = [
    (master_doc, 'egta', 'Empirical Game-Theoretic Analysis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'egta', 'Empirical Game-Theoretic Analysis Documentation',
     author, 'egta', 'One line description of project.',
     'Miscellaneous'),
]
